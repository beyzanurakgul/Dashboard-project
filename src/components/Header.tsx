...
const Header: React.FC<HeaderProps> = ({ toggleSidebar }) => {
  ...
  <div className="flex items-center">
    <button onClick={toggleSidebar} className="mr-4 text-blue-800 text-2xl focus:outline-none">
      <BsList />
    </button>
  </div>

  
  <div className='text-xl text-blue-800 flex items-center'>
  ...
  <div className="flex items-center">
    <button onClick={toggleFullScreen} className="mr-4 text-blue-800 text-2xl focus:outline-none">
      <AiOutlineFullscreen />
    </button>
